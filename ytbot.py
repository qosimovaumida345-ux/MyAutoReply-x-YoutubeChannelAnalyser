...
def create_ytbot():
    ...
    async def help_cmd(client, message):
        ...
        help_text = (
            ...
            "`/mass <kanal URL> [matn]` - Barcha akkauntlardan Like, Sub, Comment\n"
            ...
            "`/roast` - Hazil tariqasida 'roast' (tanqid) qilish\n"
            "`/addrival <kanal>` - Raqobatchi kanalni kuzatishga qo'shish\n"
            ...
            "🤖 `Shaxsiy Userbot Buyruqlari (har qanday chatda ishlaydi):`\n"
            "`.ar on/off` - Avto-javobni yoqish/o'chirish\n"
            "`.arstyle` - AI ga yozish uslubingizni o'rgatish (shu chat orqali)\n"
            "`.arvoice <id>` - ElevenLabs orqali ovozli javob berish uchun Voice ID o'rnatish\n"
            "`.arsetprompt <text>` - Maxsus AI javob yo'riqnomasini o'rnatish\n"
            "`.arhelp` - Userbotning barcha buyruqlarini ko'rish"
